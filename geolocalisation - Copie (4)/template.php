...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="../balise/balise.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-map-marker fa-fw"></i>Géolocalisation</a>
    <a href="../radio/radio.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-microphone fa-fw "></i>Radio</a>
    <a href="../bom/bom.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-truck fa-fw"></i>Véhicule de collecte</a>
